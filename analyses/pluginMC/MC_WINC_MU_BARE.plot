# BEGIN PLOT /MC_WINC_MU_BARE/W_chargeasymm_eta
...
# BEGIN PLOT /MC_WINC_MU_BARE/W_chargeasymm_pT
...
# BEGIN PLOT /MC_WINC_MU_BARE/W_mass
Title=W mass
XLabel=$m_{\text{W}}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}m_{\text{W}}$ [pb/GeV]
# END PLOT

# BEGIN PLOT /MC_WINC_MU_BARE/W_pT$
...
# BEGIN PLOT /MC_WINC_MU_BARE/W_pT_peak
...
# BEGIN PLOT /MC_WINC_MU_BARE/W_y
...
# BEGIN PLOT /MC_WINC_MU_BARE/W_phi
Title=W azimuthal angle
XLabel=$\phi_{\text{W}}$
YLabel=$\text{d}\sigma/\text{d}\phi_{\text{W}}$ [pb]
# END PLOT

# BEGIN PLOT /MC_WINC_MU_BARE/Wplus_pT$
...
# BEGIN PLOT /MC_WINC_MU_BARE/Wminus_pT$
Title=$p_\perp$ of $W^-$ boson
XLabel=$p_\perp^{W^-}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}p_\perp^{W^-}$ [pb/GeV]
LogX=1
...
# BEGIN PLOT /MC_WINC_MU_BARE/lepton_pT
...
# BEGIN PLOT /MC_WINC_MU_BARE/lepton_eta
Title=Lepton $\eta$
XLabel=$\eta_{\text{l}}$
