# BEGIN PLOT /MC_ZINC_EL/Z_mass
Title=Z mass
XLabel=$m_{\text{Z}}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}m_{\text{Z}}$ [pb/GeV]
# END PLOT

# BEGIN PLOT /MC_ZINC_EL/Z_pT$
Title=Z $p_\perp$
...
# BEGIN PLOT /MC_ZINC_EL/Z_pT_peak
...
# BEGIN PLOT /MC_ZINC_EL/lepton_eta
Title=Lepton $\eta$
