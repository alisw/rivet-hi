# BEGIN PLOT /MC_ZINC_MU_BARE/Z_mass
Title=Z mass
XLabel=$m_{\text{Z}}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}m_{\text{Z}}$ [pb/GeV]
# END PLOT

# BEGIN PLOT /MC_ZINC_MU_BARE/Z_pT$
Title=Z $p_\perp$
...
# BEGIN PLOT /MC_ZINC_MU_BARE/Z_pT_peak
...
# BEGIN PLOT /MC_ZINC_MU_BARE/Z_y
Title=Z rapidity
XLabel=$y_{\text{Z}}$
...
# BEGIN PLOT /MC_ZINC_MU_BARE/Z_phi
Title=Z azimuthal angle
XLabel=$\phi_{\text{Z}}$
YLabel=$\text{d}\sigma/\text{d}\phi_{\text{Z}}$ [pb]
# END PLOT

# BEGIN PLOT /MC_ZINC_MU_BARE/lepton_pT
...
# BEGIN PLOT /MC_ZINC_MU_BARE/lepton_eta
Title=Lepton $\eta$
