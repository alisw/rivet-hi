# BEGIN PLOT /MC_WINC_MU/W_chargeasymm_eta
...
# BEGIN PLOT /MC_WINC_MU/W_chargeasymm_pT
...
# BEGIN PLOT /MC_WINC_MU/W_mass
Title=W mass
XLabel=$m_{\text{W}}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}m_{\text{W}}$ [pb/GeV]
# END PLOT

# BEGIN PLOT /MC_WINC_MU/W_pT$
...
# BEGIN PLOT /MC_WINC_MU/W_pT_peak
...
# BEGIN PLOT /MC_WINC_MU/Wminus_pT$
Title=$p_\perp$ of $W^-$ boson
XLabel=$p_\perp^{W^-}$ [GeV]
YLabel=$\text{d}\sigma/\text{d}p_\perp^{W^-}$ [pb/GeV]
LogX=1
...
# BEGIN PLOT /MC_WINC_MU/lepton_pT
...
# BEGIN PLOT /MC_WINC_MU/lepton_eta
Title=Lepton $\eta$
XLabel=$\eta_{\text{l}}$
